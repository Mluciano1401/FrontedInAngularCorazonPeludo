     ...
     async function populateTable() {
      try {
        ...
        data.data.forEach(item => {
          ...
          <button id="editar-${item.alimentoId}" class="btn btn-primary btn-sm me-1"><a style="text-decoration: none;" href="../../../../public/enums/registroalimento.html?id${item.alimentoId}">Editar</a></button>
